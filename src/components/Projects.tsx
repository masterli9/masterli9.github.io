      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <article className="p-6 bg-gray-800 rounded-lg">
            ...
            <p className="text-gray-300 mt-2">Aplikace pro menší kapely — krátký popis (placeholder)</p>
          </article>
          <article className="p-6 bg-gray-800 rounded-lg">
            <h3 className="font-semibold">The GT Series</h3>
            <p className="text-gray-300 mt-2">Web pro prezentaci závodní ligy — krátký popis (placeholder)</p>
          </article>
        </div>
      </div>
    </section>
